  <header class="main-header">
    ...
    <a href="<?php echo base_url('seller/dashboard')?>" class="logo">
      ...
      <span class="logo-lg"><b>Dens</b>Shop</span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
     <?php echo form_open_multipart(base_url('seller/user/profile'));  ?>
          ...
          <li class="dropdown user user-menu">
            ...
            <?php }else{  ?>
              ...
              <?php  } ?>
                ...
                <p>
                  <?php echo $this->session->userdata('nama'); ?> - <?php echo $this->session->userdata('akses_user'); ?>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('seller/user/profile')?>" class="btn btn-default btn-flat">Profile</a>
                </div>
