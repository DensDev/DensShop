...
echo form_open_multipart(base_url('seller/user/profile'),' class="form-horizontal"');
      ...
      <div class="col-md-3 control-label">
        <div class="text-center">
          <?php if($profile->gambar !="") { ?>
          	...
          	<?php }else{  ?>
              <img src="<?php echo base_url()?>assets/admin/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image" width="160" height="160">
              <?php  } ?>
        </div>
      </div>
      <!-- edit form column -->
