 ...
 <table class="table table-bordered" id="example1">
 	...
 	<tr> 
 		...
 		<tr> 
 			...
 			<td>
 				<a href="<?php echo base_url('admin/produk/delete_gambar/'.$produk->id_produk.'/'.$row->id_gambar)?>" class="btn btn-danger btn-xs" onClick="return confirm('Yakin ingin menghapus Gambar ini?')"><i class="fa fa-trash-o"></i> Hapus Gambar</a>
 			</td>
 		</tr>
 		<?php } ?>
 	</tbody>
